...
- `plugins/` - Plugin system: `Plugin` trait, registry (98 built-in, ~40 with AST-based config parsing), `config_parser.rs` (Oxc-based helpers), `tooling.rs` (general tooling dep detection)
