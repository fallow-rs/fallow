...
- `plugins/` - Plugin system: `Plugin` trait, registry (109 built-in, ~41 with AST-based config parsing), `config_parser.rs` (Oxc-based helpers), `tooling.rs` (general tooling dep detection)
