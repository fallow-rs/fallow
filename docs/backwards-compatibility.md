...
- **Every machine envelope states its default verdict in `gate_outcomes`.**
  ...
  line. `fallow report --from` and the pull-request decision surface now show
