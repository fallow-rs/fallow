...
const REQUIRED_FOCUSED_CASES = [
  ...
  "protocol v7 discovers public entry points from a nested package project",
  "protocol v7 includes a direct test consumer in targeted tests",
  "protocol v7 finds semantic consumers and tests across selected projects",
  "protocol v7 confirms complete closed-world absence of static class-member references",
  "protocol v7 preserves required interface, abstract, and inherited contracts",
  "protocol v7 abstains for optional contracts, decorators, and dynamic member access",
  "protocol v7 does not treat paired accessors as uses of each other",
];
