//! Levenshtein-distance helpers for typo detection.
//!
//! One algorithm and one distance and length policy for every "did you mean?"
//! suggestion: rule names, plugin enablers, and suppression issue kinds.
//! `fallow-config` re-exports this module unchanged.
