...
pub const ISSUE_RESULT_META: &[IssueResultMeta] = &[
    ...
    IssueResultMeta {
        code: "unused-dependency-override",
        sarif_description: "Package-manager override target is not declared or resolved",
        meta_description: "A dependency override targets a package not declared by any workspace package and not present in the active readable lockfile.",
        meta_docs_path: "explanations/dead-code#unused-dependency-overrides",
        meta_name: "Unused dependency override",
    ...
    IssueResultMeta {
        code: "misconfigured-dependency-override",
        sarif_description: "Package-manager override has an unparsable key or value",
        meta_description: "A dependency override key or value does not parse according to its package manager's grammar.",
        meta_docs_path: "explanations/dead-code#misconfigured-dependency-overrides",
        meta_name: "Misconfigured dependency override",
