...
pub struct ImpactClosure {
    ...
    pub(crate) affected_not_shown: Vec<FileId>,
    /// Coordination gaps: changed contracts consumed by non-diff modules.
    pub(crate) coordination_gap: Vec<CoordinationGap>,
}
