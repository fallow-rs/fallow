...
use super::super::{
    ...
    module_federation::ModuleFederationPlugin, msw::MswPlugin, napi_rs::NapiRsPlugin,
    ...
    opennext_cloudflare::OpenNextCloudflarePlugin, oxfmt::OxfmtPlugin, oxlint::OxlintPlugin,
    ...
    simple_git_hooks::SimpleGitHooksPlugin, size_limit::SizeLimitPlugin,
