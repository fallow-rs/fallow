...
pub use fallow_types::results::{
    ...
    PolicyRuleKind, PolicyViolation, PolicyViolationSeverity, PrivateTypeLeak, ReExportCycle,
    ReExportCycleKind, ReferenceLocation, SecurityAttackSurfaceEntry, SecurityCandidate,
