...
pub(crate) use entry_points::{
    ...
    discover_plugin_entry_point_sets_timed, discover_workspace_entry_points_with_runtime_scripts,
    resolve_entry_path, warn_skipped_entry_summary, workspace_runtime_script_seeds,
};
