...
use crate::common::run_fallow_raw_with_env;
...
fn run_agent(root: &Path, home: &Path, args: &[&str]) -> crate::common::CommandOutput {
...
fn install_is_idempotent_and_uninstall_round_trips() {
    ...
    let json = crate::common::parse_json(&first);
    ...
    let json = crate::common::parse_json(&second);
