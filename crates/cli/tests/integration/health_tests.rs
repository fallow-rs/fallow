...
fn run_health_with_baseline(root: &Path, extra: &[&str]) -> crate::common::CommandOutput {
    let mut args = vec![
        "--complexity",
        "--max-cyclomatic",
        "3",
...
fn run_health_baseline_human(root: &Path, extra: &[&str]) -> crate::common::CommandOutput {
...
fn health_stale_baseline_gate_leaves_json_output_unchanged() {
    ...
    let run = |extra: &[&str]| -> crate::common::CommandOutput {
        let mut args = vec![
            "--baseline",
            baseline_path.to_str().unwrap(),
            "--baseline-mode",
...
";
    ...
    let monorepo = crate::common::run_fallow_in_root(
        "health",
        root,
        &[
            "--score",
    ...
    let scoped = crate::common::run_fallow_in_root(
        "health",
        root,
        &[
            "--score",
...
",
    ...
    let sarif = crate::common::run_fallow_in_root(
        "health",
        root,
        &[
            "--complexity",
    ...
    let cc = crate::common::run_fallow_in_root(
        "health",
        root,
        &[
            "--complexity",
