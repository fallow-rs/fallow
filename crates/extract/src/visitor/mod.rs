...
/// instance (not merely a type annotation). See issue #1441 (Part A), Codex
/// over-credit finding on type-only alias promotion.
#[derive(Debug, Clone)]
...
pub(crate) struct ModuleInfoExtractor {
    ...
    /// falsely prove it. See #1441 (Part A), Codex over-credit finding (round 2).
...
impl ModuleInfoExtractor {
    ...
    ///   into cross-module credit. See #1441 (Part A), Codex over-credit finding.
    ...
    /// no class-proven write is not proven. See #1441 (Part A), Codex round 2.
    fn value_prove_alias(&self, fn_name: &str, returned_id: &str) -> Option<String> {
        ...
        // the same class is harmless. See #1441 (Part A), Codex round 4.
