...
```jsonc
// .fallowrc.json
{ "rulePacks": ["./.fallow/rule-packs/team-policy.jsonc"] }
```

```jsonc
// .fallow/rule-packs/team-policy.jsonc
{
  "version": 1,
  "name": "team-policy",
  "rules": [
